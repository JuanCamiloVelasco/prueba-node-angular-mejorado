...
var RabbitMQClient = /** @class */ (function () {
    ...
    RabbitMQClient.prototype.initialize = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _a, _b, _c, replyQueueName, error_1;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, this.consumerChannel.assertQueue('', { exclusive: true })];
                    case 5:
                        replyQueueName = (_d.sent()).queue;
    ...
    RabbitMQClient.prototype.produce = function (queue, data) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        _a.label = 2;
                    case 2: return [4 /*yield*/, this.producer.producerMessages(queue, data)];
